...
if (isset($_GET['edit_hotelstaff'])) {
    $id=$_GET['edit_hotelstaff'];
    $select_query="SELECT * FROM `hotelstaff` where Id='$id'";
...
if (isset($_POST['update_post'])) {
    ...
    $staff_update = "UPDATE `hotelstaff` SET Full_name='$fullname', Role='$role', Images='$Image' WHERE Id='$id'";
